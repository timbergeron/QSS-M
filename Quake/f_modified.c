...
// original models
static const unsigned int progs_armor_mdl_FMOD_DM_FMOD_TF[5]				= {0x18d1b8ef, 0xfe43d973, 0xbb104313, 0xef6a9090, 0x2b048696};
static const unsigned int progs_backpack_mdl_FMOD_DM_FMOD_TF[5]			= {0x80cedaeb, 0x18f7d282, 0xa911e7c2, 0xffe609aa, 0x050a6005};
static const unsigned int progs_bolt2_mdl_FMOD_DM_FMOD_TF[5]				= {0x14fba8de, 0x99237ae4, 0xc8806043, 0xebeea454, 0x024a99a9};
static const unsigned int progs_end1_mdl_FMOD_DM_FMOD_TF[5]				= {0xd1fed19f, 0x5d67c632, 0x1d72a0e6, 0x14ab39d7, 0x4bf435c4};
static const unsigned int progs_end2_mdl_FMOD_DM_FMOD_TF[5]				= {0x98eee620, 0x107acd79, 0x8331620d, 0x2a9a1848, 0x64d29e1a};
static const unsigned int progs_end3_mdl_FMOD_DM_FMOD_TF[5]				= {0x7f1e336d, 0xe04f4bb0, 0x4ac25a1a, 0x2caedde7, 0x09973319};
static const unsigned int progs_end4_mdl_FMOD_DM_FMOD_TF[5]				= {0xa4b572aa, 0xdd00c38d, 0x130f8da2, 0x797f0e55, 0xcca52b76};
static const unsigned int progs_eyes_mdl_FMOD_DM_FMOD_TF[5]				= {0x276f25a8, 0xc6b8f782, 0x3ef75d52, 0x911d163e, 0x5d79e557};
static const unsigned int progs_g_light_mdl_FMOD_DM_FMOD_TF[5]			= {0xcb9b9366, 0x1fd74d91, 0x9a6a82f6, 0x5d6b2e3e, 0xc458f5ac};
static const unsigned int progs_g_nail_mdl_FMOD_DM_FMOD_TF[5]			= {0x7b209f71, 0xa77cd00f, 0x91f24953, 0x932f264b, 0x350e7440};
static const unsigned int progs_g_nail2_mdl_FMOD_DM_FMOD_TF[5]			= {0x97cb4499, 0x88e3e11a, 0xecec6eca, 0x883f6c8f, 0xac7ecf0c};
static const unsigned int progs_g_rock_mdl_FMOD_DM_FMOD_TF[5]			= {0x9017dd83, 0x150d954c, 0x9b5f4544, 0x10843b72, 0x4697068e};
static const unsigned int progs_g_rock2_mdl_FMOD_DM_FMOD_TF[5]			= {0x5a47ec20, 0xd0211cdc, 0xd6b8af60, 0xaf813eab, 0xba330b5b};
static const unsigned int progs_g_shot_mdl_FMOD_DM_FMOD_TF[5]			= {0x35a735e1, 0xc1ee6090, 0x9f8940b5, 0x6cdefd1c, 0x7eec1d67};
static const unsigned int progs_gib1_mdl_FMOD_DM_FMOD_TF[5]				= {0x99dc9ea4, 0x6e9bf74a, 0x25710a1e, 0x701fc77b, 0x09777092};
static const unsigned int progs_gib2_mdl_FMOD_DM_FMOD_TF[5]				= {0x5ac3e29b, 0xd66358d9, 0x1044d27a, 0xb3da48ad, 0x5f1e9fbb};
static const unsigned int progs_gib3_mdl_FMOD_DM_FMOD_TF[5]				= {0xc6558e61, 0x13ea4f63, 0x20c9da45, 0x0640212e, 0x7b98f350};
static const unsigned int progs_grenade_mdl_FMOD_DM_FMOD_TF[5]			= {0x60dfffb8, 0xfc871f0c, 0xd9f3c325, 0x61aadcaf, 0x0ec37cbf};
static const unsigned int progs_invisibl_mdl_FMOD_DM_FMOD_TF[5]			= {0x23e2f389, 0x8479657f, 0x437e0d25, 0xee100bae, 0xbad6a775};
static const unsigned int progs_invulner_mdl_FMOD_DM_FMOD_TF[5]			= {0x987ee175, 0xfd0d4f35, 0x06d2641c, 0x725c0dc8, 0x871f537a};
static const unsigned int progs_missile_mdl_FMOD_DM_FMOD_TF[5]			= {0x9adfeee8, 0x185872c1, 0xb3bb36f8, 0x996e29ab, 0xd46ab2a9};
static const unsigned int progs_quaddama_mdl_FMOD_DM_FMOD_TF[5]			= {0x2760f663, 0x32dc8405, 0x057563df, 0x9614c3a7, 0x0125949b};
static const unsigned int progs_s_spike_mdl_FMOD_DM_FMOD_TF[5]			= {0xf308f8e5, 0xcdc242e2, 0x4f71b01f, 0xafb9880a, 0x52198e9f};
static const unsigned int progs_spike_mdl_FMOD_DM_FMOD_TF[5]				= {0xebd9adaf, 0xfb3b2f28, 0x67cc2c34, 0x926ec21a, 0x09e1a233};
static const unsigned int progs_suit_mdl_FMOD_DM_FMOD_TF[5]				= {0xb7dcb9dd, 0xed8da03b, 0x416efc5e, 0x8ee38d5a, 0x4063bf25};
static const unsigned int progs_player_mdl_FMOD_DM[5]					= {0x95ca0ab4, 0x021be62e, 0x6655e9a5, 0xd4a7ef1c, 0xb484582f};
static const unsigned int progs_player_mdl_FMOD_TF[5]					= {0x8fcab658, 0x027a97ef, 0xa96eee3d, 0xc1e44f46, 0x18a533c9};
// NOTE: the following Team Fortress entries are inherited placeholder hashes
// from ezQuake (note the hand-incremented first word and identical trailing
// words). They will never match a real asset, so these models always report as
// "modified" - but only when TF checking is active. Left as-is to avoid drifting
// from ezQuake's table during the port.
static const unsigned int progs_tf_flag_mdl_FMOD_TF[5]					= {0x6e969df0, 0xc91b9eef, 0x84cb1a40, 0xcaee122e, 0x1b1d3d28};
static const unsigned int progs_stag_mdl_FMOD_TF[5]						= {0x6e970df0, 0xc91b9eef, 0x84cb1a40, 0xcaee122e, 0x1b1d3d28};
static const unsigned int progs_basrkey_bsp_FMOD_TF[5]					= {0x6e971df0, 0xc11b9eef, 0x84cb1a40, 0xcaee122e, 0x1b1d3d28};
static const unsigned int progs_basbkey_bsp_FMOD_TF[5]					= {0x6e972df0, 0xc21b9eef, 0x84cb1a40, 0xcaee122e, 0x1b1d3d28};
static const unsigned int progs_w_s_key_mdl_FMOD_TF[5]					= {0x6e973df0, 0xc31b9eef, 0x84cb1a40, 0xcaee122e, 0x1b1d3d28};
static const unsigned int progs_w_g_key_mdl_FMOD_TF[5]					= {0x6e974df0, 0xc41b9eef, 0x84cb1a40, 0xcaee122e, 0x1b1d3d28};
static const unsigned int progs_b_g_key_mdl_FMOD_TF[5]					= {0x6e975df0, 0xc51b9eef, 0x84cb1a40, 0xcaee122e, 0x1b1d3d28};
static const unsigned int progs_b_s_key_mdl_FMOD_TF[5]					= {0x6e976df0, 0xc61b9eef, 0x84cb1a40, 0xcaee122e, 0x1b1d3d28};
static const unsigned int progs_ff_flag_mdl_FMOD_TF[5]					= {0x6e977df0, 0xc71b9eef, 0x84cb1a40, 0xcaee122e, 0x1b1d3d28};
static const unsigned int progs_harbflag_mdl_FMOD_TF[5]					= {0x6e978df0, 0xc81b9eef, 0x84cb1a40, 0xcaee122e, 0x1b1d3d28};
static const unsigned int progs_princess_mdl_FMOD_TF[5]					= {0x6e979df0, 0xc92b9eef, 0x84cb1a40, 0xcaee122e, 0x1b1d3d28};
static const unsigned int progs_turrbase_mdl_FMOD_TF[5]					= {0x0cda73d5, 0x822703cb, 0x9e6cbe6b, 0x94fb95f7, 0xc7c04bed};
static const unsigned int progs_turrgun_mdl_FMOD_TF[5]					= {0x314b126f, 0x7d8d7cb5, 0x8df185c8, 0x1f3662f7, 0xa272957b};
static const unsigned int progs_disp_mdl_FMOD_TF[5]						= {0x5596fa4a, 0xd94e2457, 0x140f84df, 0x5859dda8, 0xe96752fc};
static const unsigned int progs_tf_stan_mdl_FMOD_TF[5]					= {0x1b732a1b, 0x763069c2, 0xe779e270, 0x252b9daa, 0xddf7db2a};
static const unsigned int progs_hgren2_mdl_FMOD_TF[5]					= {0x1dc3715f, 0x58c53c0f, 0xdb1504fc, 0xab354bdf, 0x6aacee97};
static const unsigned int progs_grenade2_mdl_FMOD_TF[5]					= {0x4b116cef, 0xebc6f074, 0x2acdea73, 0x876a8716, 0xe5e7409d};
static const unsigned int progs_detpack_mdl_FMOD_TF[5]					= {0xaf73d4e1, 0x0c98dc38, 0x6d3983c0, 0xd7a70033, 0x616a675e};
static const unsigned int progs_s_bubble_spr_FMOD_DM_FMOD_TF[5]			= {0x3dbefaf2, 0x73b38654, 0x70910774, 0xdfe285f3, 0x4db5d90e};
static const unsigned int progs_s_explod_spr_FMOD_DM_FMOD_TF[5]			= {0x295a7b06, 0xacdf1f88, 0x50a20894, 0x5c75905f, 0xb9d95d0b};
static const unsigned int maps_b_bh100_bsp_FMOD_DM_FMOD_TF[5]			= {0x65e7e302, 0x94a85b4d, 0x8092e674, 0xf700e5f0, 0xde667fcc};
static const unsigned int sound_buttons_airbut1_wav_FMOD_DM_FMOD_TF[5]	= {0x47d5141e, 0xc925e8eb, 0x26e5583c, 0xc8dfd021, 0x226792ef};
static const unsigned int sound_items_armor1_wav_FMOD_DM_FMOD_TF[5]		= {0x44488db0, 0xef0b0a1d, 0x3acda8b4, 0x3d87b467, 0xe4dd4fcc};
static const unsigned int sound_items_damage_wav_FMOD_DM_FMOD_TF[5]		= {0x197778ac, 0x92a252c5, 0x90c30256, 0x7ba6f264, 0x56ab654f};
static const unsigned int sound_items_damage2_wav_FMOD_DM_FMOD_TF[5]		= {0x719a9b4d, 0x1c76b218, 0xfcbf979f, 0x5ea5e6fa, 0x68afda0e};
static const unsigned int sound_items_damage3_wav_FMOD_DM_FMOD_TF[5]		= {0xfa07de6c, 0x6e306d39, 0x7d18f3ed, 0x90272558, 0x63d01e7a};
static const unsigned int sound_items_health1_wav_FMOD_DM_FMOD_TF[5]		= {0xebdd17b2, 0xa1289b80, 0x7810e3f2, 0xdb8d01bf, 0x0b495a96};
static const unsigned int sound_items_inv1_wav_FMOD_DM_FMOD_TF[5]		= {0xa01240b8, 0xb588d430, 0xc62406e0, 0x39e59dfd, 0xad5a4b98};
static const unsigned int sound_items_inv2_wav_FMOD_DM_FMOD_TF[5]		= {0x9ab6025d, 0x2d9d24a2, 0xc127b17c, 0x019e908a, 0xa521f7d3};
static const unsigned int sound_items_inv3_wav_FMOD_DM_FMOD_TF[5]		= {0xfb785777, 0x9c622826, 0x6121d05c, 0xf42d5661, 0xa34a5429};
static const unsigned int sound_items_itembk2_wav_FMOD_DM_FMOD_TF[5]		= {0x178c519b, 0x3b030527, 0x759aaed2, 0xf7dca7d7, 0xf01a1e36};
static const unsigned int sound_player_land_wav_FMOD_DM_FMOD_TF[5]		= {0xb8bb5e41, 0xf087ad8e, 0x13323cd5, 0x2e2d2052, 0x338e9e38};
static const unsigned int sound_player_land2_wav_FMOD_DM_FMOD_TF[5]		= {0x6c13b55c, 0xc46c1589, 0xeeabac42, 0x087cd24e, 0xd9552386};
static const unsigned int sound_misc_outwater_wav_FMOD_DM_FMOD_TF[5]		= {0x9cb6fc36, 0x9c20e9ba, 0x595f8418, 0x50e76d9f, 0xa7503dfd};
static const unsigned int sound_weapons_pkup_wav_FMOD_DM_FMOD_TF[5]		= {0x05a43523, 0x09bbab60, 0x77ce67a0, 0xb52fe23d, 0xf2715701};
static const unsigned int sound_player_plyrjmp8_wav_FMOD_DM_FMOD_TF[5]	= {0x75e2e946, 0xc9ad54f2, 0x6cd47b03, 0xeef0c9d4, 0x5d3386da};
static const unsigned int sound_items_protect_wav_FMOD_DM_FMOD_TF[5]		= {0x38ff1351, 0x7d6799c7, 0x7577256d, 0xbf233192, 0xb6223baa};
static const unsigned int sound_items_protect2_wav_FMOD_DM_FMOD_TF[5]	= {0x588dd159, 0xae489f2c, 0x22f7118e, 0x487eeb4c, 0x3c54c997};
static const unsigned int sound_items_protect3_wav_FMOD_DM_FMOD_TF[5]	= {0x869a1143, 0xc9e6a404, 0xcbd5d90e, 0xa1b57e4c, 0xae77dd20};
static const unsigned int sound_items_r_item1_wav_FMOD_DM_FMOD_TF[5]     = {0xdde12941, 0xfbb3b804, 0x776cf5fa, 0xe81df8ea, 0xa1429f63};
static const unsigned int sound_items_r_item2_wav_FMOD_DM_FMOD_TF[5]     = {0xd9da4047, 0x5a7b191a, 0xc02d860d, 0x18f679de, 0xc47bd93a};
static const unsigned int sound_misc_water1_wav_FMOD_DM_FMOD_TF[5]		= {0x8625dbc7, 0xbaf30ae6, 0xfdb53965, 0x2d7eb9d6, 0xf9fd9304};
static const unsigned int sound_misc_water2_wav_FMOD_DM_FMOD_TF[5]		= {0xccda75ec, 0xfb5cd780, 0xe2d73b5b, 0x9f3560ad, 0x4e116b85};

static const unsigned int sound_misc_menu1_wav_FMOD_DM_FMOD_TF[5]		= {0x2e19b817, 0x0c0e1c5f, 0xd7a0ecf8, 0xb278c27e, 0xb0e1923c};
static const unsigned int sound_misc_menu2_wav_FMOD_DM_FMOD_TF[5]		= {0xd6719ab1, 0x0a407e2b, 0xb03a053b, 0x2a4bc2cb, 0x61cd7ff3};
static const unsigned int sound_misc_menu3_wav_FMOD_DM_FMOD_TF[5]		= {0xae120b9a, 0x3a217d2e, 0xc34f0990, 0x2d4332ed, 0x97c18f76};
static const unsigned int sound_misc_talk_wav_FMOD_DM_FMOD_TF[5]			= {0x5b15321c, 0x1af2d826, 0xb0228e9f, 0x49c06f56, 0xa8355e8b};
static const unsigned int sound_misc_basekey_wav_FMOD_DM_FMOD_TF[5]		= {0x926134ce, 0x22806dd3, 0x1952624a, 0x8f43f7e9, 0xa6fdfe64};
static const unsigned int sound_doors_runeuse_wav_FMOD_DM_FMOD_TF[5]		= {0xf41d6d59, 0xe99b93e8, 0x15edfd25, 0x668a499c, 0x1ac62572};

static const unsigned int gfx_colormap_lmp_FMOD_DM_FMOD_TF[5]			= {0xa93b3795, 0x17016397, 0x0a761d38, 0x4866e67d, 0x3c2a2a75};
static const unsigned int gfx_palette_lmp_FMOD_DM_FMOD_TF[5]			= {0xa6a2e242, 0xbad0f7da, 0xe263351f, 0x6d51f8ad, 0x49a45d4a};
...
// woods #f_modified -- original Threewave CTF models (ctf3maps.pak, 1996).
// CTF ships its own player.mdl, so register it as a legal alternate of the
// stock player.mdl to avoid a false "modified" in CTF. The CTF-only models are
// added as canonical check entries so a tampered version is still caught.
// (h_player.mdl is intentionally omitted: it is a stock id1 model loaded in all
// deathmatch, so checking it against only the CTF hash would false-positive in
// vanilla play. Adding it properly would need the vanilla hash as primary.)
static const unsigned int progs_flag_mdl_CTF[5]		= {0x34ce3fdc, 0x869d8aa6, 0xfd51ac66, 0x0fd5c924, 0x875762be};
static const unsigned int progs_bit_mdl_CTF[5]		= {0xcef32978, 0xb046b09c, 0x5ff483f1, 0x2e72f0be, 0xeabf2e49};
static const unsigned int progs_star_mdl_CTF[5]		= {0xd7c42848, 0x3e55808b, 0xc26a6fc4, 0xc603ed96, 0x904c9201};
static check_models_hashes_entry_t mdlhash_ctf_player = { {0x51f0b43e, 0x8f679faa, 0x23291534, 0xe77a4c9f, 0x0248153e}, NULL };
...
typedef struct check_models_s {
	...
	check_models_hashes_entry_t*
				hash_alt;
	const char*	variant;	// woods #f_modified -- label for a recognized non-canonical variant (e.g. "remaster"), else NULL
} check_models_t;

static check_models_t check_models[MAX_CHECK_MODELS];
static int check_models_num = 0;
static float fmod_warn_time = 0.0f;
static qboolean fmod_teamfortress = false;

/* QSS-M has no ezQuake-style ruleset system, so every known-alternate hash is
   always accepted. Kept as a hook in case a policy is ever added. */
static qboolean FMod_AllowAlternateModel(const char *name)
{
	return true;
}

static qboolean FMod_IsTeamFortressAsset(const char *name)
{
	return !q_strcasecmp(name, "progs/tf_flag.mdl") ||
		!q_strcasecmp(name, "progs/turrbase.mdl") ||
		!q_strcasecmp(name, "progs/turrgun.mdl") ||
		!q_strcasecmp(name, "progs/disp.mdl");
}

static qboolean FMod_IsTeamFortressMode(void)
{
	int i;

	if (fmod_teamfortress)
		return true;

	for (i = 1; i < cl.model_count && i < MAX_MODELS; i++)
	{
		if (cl.model_name[i][0] && FMod_IsTeamFortressAsset(cl.model_name[i]))
		{
			fmod_teamfortress = true;
			return true;
		}
	}

	return fmod_teamfortress;
}

// The ezQuake hash tables store each 20-byte SHA1 as five unsigned ints written
// in the order the digest reads (e.g. 0x18d1b8ef). Compare word-by-word in
// little-endian byte order rather than memcmp() so the literals are interpreted
// identically on any host endianness.
static qboolean FMod_HashMatchesDigest (const unsigned int words[5], const unsigned char digest[SHA1_DIGEST_SIZE])
{
	int i;

	for (i = 0; i < 5; i++)
	{
		if (digest[i * 4 + 0] != (unsigned char)(words[i]        & 0xff) ||
...
static qboolean FMod_IsModelModified (const char *name, const int flags, const byte *buf, const size_t len)
{
	int i;
	unsigned char hash[SHA1_DIGEST_SIZE];
	qboolean found = false;

	if (CalcHash(&hash_sha1, hash, sizeof(hash), buf, len) != sizeof(hash))
		return true;
	...
	if (found) {
		if (FMod_HashMatchesDigest(check_models[i].hash, hash)) {
			// original model
			return false;
		}
		else {
			...
			while (cur) {
				if (FMod_HashMatchesDigest(cur->hash, hash) && FMod_AllowAlternateModel(name)) {
...
static int FMod_AddModel (const char *name, const int flags, const void *hash)
{
	if (check_models_num >= MAX_CHECK_MODELS)
		return -1;

	q_strlcpy (check_models[check_models_num].name, name, sizeof (check_models[check_models_num].name));
	...
	check_models[check_models_num].variant = NULL;
...
// woods #f_modified -- recognized non-canonical variants of checked models.
// These still report as modified (they are not the canonical asset), but are
// labelled so the report can tell e.g. the id Software 2021 remaster model from
// an arbitrary edit. Matched against whatever buffer the loader actually read --
// with r_replacemodels active that is the .md5mesh/.iqm/.md3 loaded in place of
// the .mdl, so the hash here is of progs/player.md5mesh, not the .mdl.
typedef struct {
	const char			*name;		// canonical model name, e.g. "progs/player.mdl"
	const unsigned int	hash[5];	// hash of the recognized variant
	const char			*label;		// shown in the f_modified report
} check_models_variant_t;

static const check_models_variant_t check_models_variants[] = {
	// id Software 2021 remaster player model (qeplayermd5.pak)
	{ "progs/player.mdl", {0x16ec22e6, 0x95d547cc, 0xf2f7a0da, 0xd147955f, 0x84d39247}, "remaster" },
};

static const char *FMod_VariantLabel (const char *name, const void *buf, const size_t len)
{
	unsigned char hash[SHA1_DIGEST_SIZE];
	size_t v;
	...
	for (v = 0; v < sizeof(check_models_variants)/sizeof(check_models_variants[0]); v++) {
		if (!q_strcasecmp(name, check_models_variants[v].name) &&
			FMod_HashMatchesDigest(check_models_variants[v].hash, hash))
			return check_models_variants[v].label;
	}
...
{
	int i;
	qboolean modified, relevent, teamfortress;

	if (!name || !buf || !len)
		return;

	if (FMod_IsTeamFortressAsset(name))
		fmod_teamfortress = true;
	...
	if (check_models[i].checked && !check_models[i].modified && modified) {
		if (!fmod_warn_time || (float) realtime - fmod_warn_time >= 3.0f) {
			Cbuf_AddText("say warning: models changed !!  Use f_modified again\n");
			fmod_warn_time = (float) realtime;
		}
	}

	check_models[i].modified = modified;
	check_models[i].checked = true;
	check_models[i].variant = modified ? FMod_VariantLabel (name, buf, len) : NULL;
}
...
void FMod_Init (void)
{
	...
	FMod_AddModelAlt (lastid, &mdlhash_ctf_player); // woods #f_modified -- original Threewave CTF player model
	FMod_AddModel ("progs/player.mdl",			FMOD_TF,			progs_player_mdl_FMOD_TF);

	// woods #f_modified -- original Threewave CTF models (ctf3maps.pak); CTF runs in DM mode
	FMod_AddModel ("progs/flag.mdl",			FMOD_DM,			progs_flag_mdl_CTF);
	FMod_AddModel ("progs/bit.mdl",				FMOD_DM,			progs_bit_mdl_CTF);
	FMod_AddModel ("progs/star.mdl",			FMOD_DM,			progs_star_mdl_CTF);
...
char *FMod_Response_Text(void)
{
	static char buf[512];
	int i, count;
	qboolean relevent, teamfortress;
