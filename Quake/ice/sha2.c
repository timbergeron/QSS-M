...
#if SHA2==256
static void sha224_finish (byte *digest, void *context)
{
	SHA2_CONTEXT *hd = (SHA2_CONTEXT *) context;
	sha2_final(context);
	memcpy(digest, hd->buf, 224/8);	//only the first 224 bits of the result...
}
static void sha256_finish (byte *digest, void *context)
{
	SHA2_CONTEXT *hd = (SHA2_CONTEXT *) context;
	sha2_final(context);
...
#endif
#if SHA2==512
static void sha384_finish (byte *digest, void *context)
{
	SHA2_CONTEXT *hd = (SHA2_CONTEXT *) context;
	sha2_final(context);
...
static void sha512_finish (byte *digest, void *context)
{
	SHA2_CONTEXT *hd = (SHA2_CONTEXT *) context;
	sha2_final(context);
