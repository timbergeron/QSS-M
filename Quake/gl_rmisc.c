...
extern cvar_t r_alias_light_desat; // woods - remove colored lighting from alias models #dedat
extern cvar_t r_alias_light_desat_list; // woods #dedat
...
void R_Init (void)
{
	...
	Cvar_RegisterVariable (&r_alias_light_desat); // woods #dedat
	Cvar_RegisterVariable (&r_alias_light_desat_list); // woods #dedat
