...
void R_Init (void)
{
	...
	Cvar_RegisterVariable (&r_lightmap_extra4);
	Cvar_RegisterVariable (&r_textureless_dither);
	...
	Cvar_RegisterVariable (&gl_alias_instancing);	//tb -- portable instanced draw path for repeated opaque alias models
