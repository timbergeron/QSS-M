...
char* hints[] = {
	...
	KEY_ALT_MODIFIER_NAME_LOWER "+shift+scrollwheel adjust game volume",
	KEY_SHORTCUT_MODIFIER_NAME_LOWER "-m or mute will mute volume",
	...
	KEY_SHORTCUT_MODIFIER_NAME_LOWER "-enter in console will use messagemode2 (team)",
	"uparrow and downarrow in the console for history",
	KEY_SHORTCUT_MODIFIER_NAME_LOWER "-home and " KEY_SHORTCUT_MODIFIER_NAME_LOWER "-end jump to top/bottom of console",
