...
cvar_t	r_lightmap_extra4 = {"r_lightmap_extra4", "0", CVAR_ARCHIVE}; // approximate ericw light -extra4 sampling clientside
cvar_t	r_textureless_dither = {"r_textureless_dither", "0", CVAR_ARCHIVE}; // dither textureless world lighting to hide 8-bit bands
...
cvar_t	r_noshadow_list = {"r_noshadow_list", "progs/flame2.mdl,progs/flame.mdl,progs/bolt1.mdl,progs/bolt2.mdl,progs/bolt3.mdl,progs/laser.mdl,progs/candle.mdl,progs/candle1.mdl,progs/candle2.mdl,progs/candle3.mdl,progs/misc_candle1.mdl,progs/misc_candle2.mdl,progs/misc_candle3.mdl", CVAR_ARCHIVE};
cvar_t	r_nooutline_list = {"r_nooutline_list", "progs/bolt1.mdl,progs/bolt2.mdl,progs/bolt3.mdl,progs/bit.mdl, progs/star.mdl,progs/candle.mdl,progs/candle1.mdl,progs/candle2.mdl,progs/candle3.mdl,progs/misc_candle1.mdl,progs/misc_candle2.mdl,progs/misc_candle3.mdl", CVAR_ARCHIVE}; // woods #routline
